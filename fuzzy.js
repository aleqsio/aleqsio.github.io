  ...
  C.prototype = {
    getResult: function(options) {
      var variables = this.construct(options.variables_input),
        ...
        output_combination = this.output_combination(
          fuzzy_input,
          options.inferences,
          options.variable_output,
        ),
        fuzzy_output = this.takeMaxOfArraySet(output_combination),
        crisp_output = this.defuzzification(
          fuzzy_output,
          this.construct_variable(options.variable_output.sets),
        );
